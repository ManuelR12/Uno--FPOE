...
public enum EISCUnoEnum {
    ...
    TWO_DRAW_BLUE("cards-uno/2_wild_draw_blue.png"),
    TWO_DRAW_GREEN("cards-uno/2_wild_draw_green.png"),
    TWO_DRAW_YELLOW("cards-uno/2_wild_draw_yellow.png"),
    TWO_DRAW_RED("cards-uno/2_wild_draw_red.png"),
    ...
    REVERSE_BLUE("cards-uno/reserve_blue.png"),
    REVERSE_YELLOW("cards-uno/reserve_yellow.png"),
    REVERSE_GREEN("cards-uno/reserve_green.png"),
    REVERSE_RED("cards-uno/reserve_red.png"),
